...
* `pick.py` — выбор лучшего отрезка внутри исходника: разбивает клип на кадры,
  считает резкость (дисперсия лапласиана) и межкадровое движение, затем берёт
  окно нужной длины с максимальной резкостью, ровным движением и без рывков.
